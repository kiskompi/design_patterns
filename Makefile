...
INCPATH       = -I. -I. -isystem /usr/include/QtWidgets -isystem /usr/include/QtGui -isystem /usr/include/QtCore -I. -isystem /usr/include/libdrm -I/usr/lib64/qt5/mkspecs/linux-g++
QMAKE         = /usr/bin/qmake
DEL_FILE      = rm -f
...
SOURCES       = qrc_application.cpp \
		...
		src/TRANSFER/Date.cpp qrc_application.cpp \
		moc_mainwindow.cpp
